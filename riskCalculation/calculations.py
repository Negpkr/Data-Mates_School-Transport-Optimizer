...
print("The crash density in road NorthBAvenue, GungDr, BartonHwy, and ParkesWay are: ", crashdensity_NorthBAvenue, crashdensity_GungDr, crashdensity_BartonHwy, crashdensity_ParkesWay)